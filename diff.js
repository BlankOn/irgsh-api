...
// Point the DATA_URI to an irgsh-api instance ( https://github.com/BlankOn/untung-irgsh-api )
var DATA_URI='http://localhost:8000/packages';
    ...
    debian.on('end', function(){
	  ...
	  var files = fs.readdirSync(__dirname + '/data');
          for (var i = 0; i < files.length; i++)
            fs.unlinkSync(__dirname + '/data/' + files[i]);
